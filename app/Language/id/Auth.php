...
return [
    ...
    'bannedUser'            => 'Akun diblokir.',
    'logOutBannedUser'      => 'Anda telah keluar karena Anda telah diblokir.',
    'badAttempt'            => 'Anda tidak dapat masuk. Periksa lagi kredensial Anda.',
    'noPassword'            => 'Tidak dapat memvalidasi pengguna tanpa kata sandi.',
    'invalidPassword'       => 'Tidak dapat masuk. Periksa lagi kata sandi Anda.',
    ...
    'noUserEntity'          => 'Entitas Pengguna tidak ditemukan untuk validasi kata sandi.',
    'invalidEmail'          => 'Email tidak terdaftar.',
    ...
    'useMagicLink'       => 'Minta link login',
    'magicLinkSubject'   => 'Link login Anda',
    ...
    'magicLinkDetails'   => 'Kami baru saja mengirim Anda email dengan login link di dalamnya. Ini hanya berlaku selama {0} menit.',
    'magicLinkDisabled'  => 'Penggunaan link login saat ini tidak diperbolehkan.',
    ...
    'suggestPasswordLength'     => 'Kata sandi dapat dibuat mencapai 255 karakter, kami sarankan Anda membuat kata sandi yang aman dan mudah diingat.',
    'errorPasswordCommon'       => 'Kata sandi tidak boleh menggunakan sandi yang umum.',
    ...
    'emailActivateBody'     => 'Kami baru saja mengirim email kepada Anda dengan kode untuk mengonfirmasi alamat email Anda. Salin kode tersebut dan masukkan ke bawah ini.',
    ...
    'needActivate'          => 'Anda harus menyelesaikan registrasi dengan mengonfirmasi kode yang dikirim ke alamat email Anda.',
